...
import { Client as Client$1, DecodedMessage as DecodedMessage$1 } from '@xmtp/xmtp-js';
...
declare class HandlerContext {
    ...
    private constructor();
    static create(conversation: Conversation, message: DecodedMessage | DecodedMessage$1, { client, v2client }: {
        client: Client;
        v2client: Client$1;
